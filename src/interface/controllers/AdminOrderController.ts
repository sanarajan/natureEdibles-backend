...
export const verifyManualPayment = async (req: Request, res: Response) => {
    try {
        ...
        order.statusHistory.push({
            status: `Payment Verified & Order Placed (Manual by ${adminName})`,
            timestamp: new Date(),
            updatedBy: adminName
        });
